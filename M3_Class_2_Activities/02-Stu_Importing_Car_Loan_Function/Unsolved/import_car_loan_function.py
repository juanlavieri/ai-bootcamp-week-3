...
car_value = calculate_future_value(new_car_loan["current_loan_value"], new_car_loan["months_remaining"], new_car_loan["annual_interest_rate"])

# Print the future value of the car to 2 decimal places.
print(f"Future value of the car: {car_value:.2f}")
